...
app.post('/api/v1/tours', (req, res) => {
    ...
    // here "body" means the data V wants to send to the server (in postman)
   ...
   */
    ...
    /*
        why "JSON.stringify()": V have pushed our newTour into an array but our file is of type JSON, so to put a simple array into a JSON file V caonvert the normal array to JSON array
